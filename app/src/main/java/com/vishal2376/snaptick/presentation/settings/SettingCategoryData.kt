...
val settingsFollow = listOf(
	SettingCategoryItem(title = "Twitter", resId = R.drawable.ic_twitter),
	SettingCategoryItem(title = "Github", resId = R.drawable.ic_github),
	SettingCategoryItem(title = "LinkedIn", resId = R.drawable.ic_linkedin),
	SettingCategoryItem(title = "Instagram", resId = R.drawable.ic_instagram),
)